def call(commerceDir) {
    def path = /\/core-customize/
    echo "##### Extract commerce platform ##### -- ${commerceDir}"
    //sh "unzip -o ../CXCOM2005*.ZIP -d ${commerceDir}/core-customize"
    bat "cd ../ && 7z.exe x CXCOM2005*.ZIP -o${commerceDir}${path}"
    bat "cd ../ && 7z.exe x CXCOMINTPK200500P*.ZIP -o${commerceDir}${path}"
    bat "cd ../ && 7z.exe x hybrisConfig*.ZIP -o${commerceDir}${path}"
