def call(commerceDir) {
    ...
    bat "cd ${commerceDir} && 7z.exe x CXCOM2005*.ZIP -o${commerceDir}/core-customize"
    bat "cd ${commerceDir} && 7z.exe x CXCOMINTPK200500P*.ZIP -o${commerceDir}/core-customize"
    bat "cd ${commerceDir} && 7z.exe x hybrisConfig*.ZIP -o${commerceDir}/core-customize"
